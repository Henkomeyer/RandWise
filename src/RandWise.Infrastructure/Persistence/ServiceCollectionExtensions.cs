...
using RandWise.Infrastructure.Audit;
...
using RandWise.Infrastructure.Intelligence;
using RandWise.Infrastructure.Jobs;
using RandWise.Infrastructure.Privacy;
using RandWise.Infrastructure.Reports;
...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<IPrivacyService, EfPrivacyService>();
        services.AddScoped<IAuditLogService, EfAuditLogService>();
        services.AddScoped<ICategoryRuleService, EfCategoryRuleService>();
        services.AddScoped<ICategoryClassificationService, EfCategoryClassificationService>();
        services.AddScoped<IAiCategoryClassifier, NoOpAiCategoryClassifier>();
        services.AddScoped<IBackgroundJobProcessor, EfBackgroundJobProcessor>();
        services.AddScoped<IRecurringTransactionGenerator, EfRecurringTransactionGenerator>();
